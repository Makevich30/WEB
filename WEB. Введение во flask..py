...
def form_sample():
    if request.method == 'GET':
                            ...
                            <div>
                                <form class="login_form" method="post">
                                    ...
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="prof" name="profession">
                                        <label class="form-check-label" for="acceptRules">Инженер-исследователь</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession1">
                                        <label class="form-check-label" for="acceptRules">Инженер-строитель</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession2">
                                        <label class="form-check-label" for="acceptRules">Пилот</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession3">
                                        <label class="form-check-label" for="acceptRules">Метеоролог</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession4">
                                        <label class="form-check-label" for="acceptRules">Инженер по жизнеобеспечению</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession5">
                                        <label class="form-check-label" for="acceptRules">Инженер по радиационной защите</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession6">
                                        <label class="form-check-label" for="acceptRules">Врач</label>
                                        <br><input type="checkbox" class="form-check-input" id="prof" name="profession7">
        ...
        print(request.form.get('profession1', ''))
        print(request.form.get('profession2', ''))
        print(request.form.get('profession3', ''))
        print(request.form.get('profession4', ''))
        print(request.form.get('profession5', ''))
...
def results(nickname, level, rating):
    return render_template('result_form.html', nickname=nickname, level=level, rating=rating)
